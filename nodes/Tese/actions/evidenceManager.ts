...
const BASE = '/api/v3/external/esg/evidence-manager';

export async function executeEvidenceManager(ctx: ActionContext): Promise<IDataObject> {
	...
	switch (operation) {
		...
		default:
			return unsupported(ctx, 'evidence manager');
	}
}
