...
const BASE = '/api/v3/external/esg/validation-bank';

export async function executeValidationBank(ctx: ActionContext): Promise<IDataObject> {
	...
	switch (operation) {
		...
		default:
			return unsupported(ctx, 'validation bank');
	}
}
